...
export const soundEvents = {
  ...
  falseAccusation: { channel: "demo", frequency: 260, end: 95, duration: 0.22 },
  pointGain: { channel: "demo", frequency: 480, end: 760, duration: 0.13 },
  pointLoss: { channel: "demo", frequency: 260, end: 120, duration: 0.14 },
  shield: { channel: "demo", frequency: 310, end: 620, duration: 0.17 },
  reverse: { channel: "demo", frequency: 520, end: 270, duration: 0.18 },
  targetReached: { channel: "demo", frequency: 420, end: 980, duration: 0.26 },
  vote: { channel: "demo", frequency: 320, end: 440, duration: 0.1 },
  coinFlip: { channel: "demo", frequency: 700, end: 920, duration: 0.13 },
