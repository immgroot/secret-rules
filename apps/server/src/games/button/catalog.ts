...
const DEFINITIONS: readonly Definition[] = [
  ...
  d("BUTTON_V2_TARGETED_RESOLVED", "target", "PLAY {count} TARGETED EFFECT CARD DIRECTLY.", "PLAY {count} TARGETED EFFECT.", "medium", fixed(1), { selector: "ALL_ACTIVE_PLAYERS" }),
  d("BUTTON_V2_DISTINCT_CLAIMS", "sequence", "MAKE SUCCESSFUL CLAIMS USING {count} DIFFERENT NUMBER CARDS.", "CLAIM {count} DIFFERENT NUMBERS.", "medium", fixed(3)),
  ...
  d("BUTTON_V2_EFFECT_TARGET", "target", "PLAY A DIRECT EFFECT CARD ON {target}.", "USE AN EFFECT ON {target}.", "medium", fixed(1), { selector: "RANDOM_OTHER", relationships: ["TARGETS"] }),
  ...
  d("BUTTON_V2_BLUFF_DISTINCT_CLAIMS", "sequence", "SUCCESSFULLY BLUFF USING {count} DIFFERENT CLAIMED NUMBERS.", "BLUFF WITH {count} CLAIMED NUMBERS.", "hard", fixed(3)),
  d("BUTTON_V2_WIN_THREE_CHALLENGES", "prediction", "WIN {count} CHALLENGES THIS ROUND.", "WIN {count} CHALLENGES.", "hard", hard(3)),
  d("BUTTON_V2_EFFECT_VARIETY", "sequence", "PLAY {count} DIFFERENT EFFECT CARD TYPES DIRECTLY.", "PLAY {count} EFFECT TYPES.", "hard", fixed(2), { weight: .55 }),
